import { app as Je, BrowserWindow as Ja, ipcMain as Ka, Notification as go } from "electron";
import X from "node:path";
import { fileURLToPath as yo } from "node:url";
import ve from "util";
import $, { Readable as wo } from "stream";
import Ya from "path";
import Xa from "http";
...
const { toString: So } = Object.prototype, { getPrototypeOf: Za } = Object, { iterator: Ye, toStringTag: hi } = Symbol, Xe = /* @__PURE__ */ ((e) => (a) => {
  const n = So.call(a);
...
const bi = H("ArrayBuffer");
function Ao(e) {
  let a;
  return typeof ArrayBuffer < "u" && ArrayBuffer.isView ? a = ArrayBuffer.isView(e) : a = e && e.buffer && bi(e.buffer), a;
}
const Co = Qe("string"), z = Qe("function"), gi = Qe("number"), Ze = (e) => e !== null && typeof e == "object", To = (e) => e === !0 || e === !1, Ue = (e) => {
  if (Xe(e) !== "object")
    return !1;
  const a = Za(e);
  return (a === null || a === Object.prototype || Object.getPrototypeOf(a) === null) && !(hi in e) && !(Ye in e);
}, Oo = H("Date"), Fo = H("File"), Po = H("Blob"), qo = H("FileList"), Lo = (e) => Ze(e) && z(e.pipe), Uo = (e) => {
  let a;
...
}, Bo = H("URLSearchParams"), [zo, No, Io, Do] = ["ReadableStream", "Request", "Response", "Headers"].map(H), $o = (e) => e.trim ? e.trim() : e.replace(/^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g, "");
...
const ae = typeof globalThis < "u" ? globalThis : typeof self < "u" ? self : typeof window < "u" ? window : global, wi = (e) => !we(e) && e !== ae;
function za() {
  const { caseless: e } = wi(this) && this || {}, a = {}, n = (i, o) => {
    const t = e && yi(a, o) || o;
    Ue(a[t]) && Ue(i) ? a[t] = za(a[t], i) : Ue(i) ? a[t] = za({}, i) : he(i) ? a[t] = i.slice() : a[t] = i;
  };
  for (let i = 0, o = arguments.length; i < o; i++)
    arguments[i] && Re(arguments[i], n);
  return a;
}
const Mo = (e, a, n, { allOwnKeys: i } = {}) => (Re(a, (o, t) => {
  n && z(o) ? e[t] = vi(o, n) : e[t] = o;
}, { allOwnKeys: i }), e), Ho = (e) => (e.charCodeAt(0) === 65279 && (e = e.slice(1)), e), Go = (e, a, n, i) => {
  ...
  for (; a-- > 0; )
    n[a] = e[a];
  return n;
}, Ko = /* @__PURE__ */ ((e) => (a) => e && a instanceof e)(typeof Uint8Array < "u" && Za(Uint8Array)), Yo = (e, a) => {
  ...
  for (; (n = e.exec(a)) !== null; )
    i.push(n);
  return i;
}, Qo = H("HTMLFormElement"), Zo = (e) => e.toLowerCase().replace(
  /[-_\s]([a-z\d])(\w*)/g,
  function(n, i, o) {
    return i.toUpperCase() + o;
  }
), yn = (({ hasOwnProperty: e }) => (a, n) => e.call(a, n))(Object.prototype), et = H("RegExp"), _i = (e, a) => {
...
}, ot = (e, a) => e != null && Number.isFinite(e = +e) ? e : a;
function tt(e) {
  return !!(e && z(e.append) && e[hi] === "FormData" && e[Ye]);
}
const st = (e) => {
  ...
  return n(e, 0);
}, rt = H("AsyncFunction"), ct = (e) => e && (Ze(e) || z(e)) && z(e.then) && z(e.catch), ki = ((e, a) => e ? setImmediate : a ? ((n, i) => (ae.addEventListener("message", ({ source: o, data: t }) => {
  ...
  z(ae.postMessage)
), pt = typeof queueMicrotask < "u" ? queueMicrotask.bind(ae) : typeof process < "u" && process.nextTick || ki, lt = (e) => e != null && z(e[Ye]), d = {
  isArray: he,
  isArrayBuffer: bi,
  isBuffer: jo,
  isFormData: Uo,
...
Object.defineProperties(b, Ri);
Object.defineProperty(Ei, "isAxiosError", { value: !0 });
b.from = (e, a, n, i, o, t) => {
  const s = Object.create(Ei);
...
G.prototype.pipe = function() {
  var e = ji.prototype.pipe.apply(this, arguments);
...
var mt = ve, Ai = $.Stream, wn = dt, ft = T;
function T() {
 ...
 */
(function(e) {
  var a = vt, n = Ya.extname, i = /^\s*([^;\s]*)(?:;|\s|$)/, o = /^text\//i;
...
var kn = Ti, _t = Oi, Fi = kt;
function kt(e, a, n, i) {
  var o = n.keyedList ? n.keyedList[n.index] : n.index;
  n.jobs[o] = Et(a, o, e[o], function(t, s) {
    o in n.jobs && (delete n.jobs[o], t ? _t(n) : n.results[o] = s, i(t, n.results));
  });
}
function Et(e, a, n, i) {
  var o;
...
var ea = { exports: {} }, En = Fi, qt = Pi, Lt = qi;
ea.exports = Ut;
ea.exports.ascending = Li;
ea.exports.descending = Bt;
function Ut(e, a, n, i) {
  var o = qt(e, n);
  return En(e, a, o, function t(s, p) {
    if (s) {
      i(s, p);
      return;
    }
...
var Ui = ea.exports, zt = Ui, Nt = It;
function It(e, a, n) {
  return zt(e, a, null, n);
}
var Dt = {
  parallel: Ft,
  serial: Nt,
  serialOrdered: Ui
}, Bi = Object, $t = Error, Mt = EvalError, Ht = RangeError, Gt = ReferenceError, Vt = SyntaxError, en = TypeError, Wt = URIError, Jt = Math.abs, Kt = Math.floor, Yt = Math.max, Xt = Math.min, Qt = Math.pow, Zt = Math.round, es = Number.isNaN || function(a) {
  return a !== a;
}, as = es, ns = function(a) {
  return as(a) || a === 0 ? a : a < 0 ? -1 : 1;
}, is = Object.getOwnPropertyDescriptor, Be = is;
if (Be)
  try {
    Be([], "length");
  } catch {
...
var zi = Be, ze = Object.defineProperty || !1;
if (ze)
  try {
    ze({}, "a", { value: 1 });
  } catch {
...
function ts() {
  if (Sn) return la;
  Sn = 1;
  var e = typeof Symbol < "u" && Symbol, a = Ni();
  return la = function() {
...
var ua, jn;
function Ii() {
  return jn || (jn = 1, ua = typeof Reflect < "u" && Reflect.getPrototypeOf || null), ua;
}
var da, An;
function Di() {
  if (An) return da;
...
var xa, On;
function an() {
  return On || (On = 1, xa = Function.prototype.call), xa;
}
var va, Fn;
function $i() {
  return Fn || (Fn = 1, va = Function.prototype.apply), va;
}
var ha, Pn;
function rs() {
  return Pn || (Pn = 1, ha = typeof Reflect < "u" && Reflect && Reflect.apply), ha;
}
var ba, qn;
function cs() {
  if (qn) return ba;
  qn = 1;
  var e = aa(), a = $i(), n = an(), i = rs();
  return ba = i || e.call(n, a), ba;
}
var ga, Ln;
function ps() {
  if (Ln) return ga;
  Ln = 1;
  var e = aa(), a = en, n = an(), i = cs();
...
function ls() {
  ...
  return ya = i && typeof i.get == "function" ? e([i.get]) : typeof t == "function" ? (
    /** @type {import('./get')} */
    function(p) {
...
function Mi() {
  ...
  return _a = n.call(e, a), _a;
}
var E, ds = Bi, ms = $t, fs = Mt, xs = Ht, vs = Gt, fe = Vt, me = en, hs = Wt, bs = Jt, gs = Kt, ys = Yt, ws = Xt, _s = Qt, ks = Zt, Es = ns, Hi = Function, ka = function(e) {
  try {
    return Hi('"use strict"; return (' + e + ").constructor;")();
  } catch {
  }
}, _e = zi, Rs = os, Ea = function() {
  throw new me();
}, Ss = _e ? function() {
  try {
...
}() : Ea, pe = ts()(), O = us(), js = Di(), As = Ii(), Gi = $i(), Se = an(), le = {}, Cs = typeof Uint8Array > "u" || !O ? E : O(Uint8Array), ie = {
  __proto__: null,
...
var Os = function e(a) {
...
}, je = aa(), De = Mi(), Fs = je.call(Se, Array.prototype.concat), Ps = je.call(Gi, Array.prototype.splice), In = je.call(Se, String.prototype.replace), $e = je.call(Se, String.prototype.slice), qs = je.call(Se, RegExp.prototype.exec), Ls = /[^%.[\]]+|\[(?:(-?\d+(?:\.\d+)?)|(["'])((?:(?!\2)[^\\]|\\.)*?)\2)\]|(?=(?:\.|\[\])(?:\.|\[\]|%$))/g, Us = /\\(\\)?/g, Bs = function(a) {
  ...
  var o = [];
  return In(a, Ls, function(t, s, p, l) {
    o[o.length] = p ? In(l, Us, "$1") : s || t;
  }), o;
}, zs = function(a, n) {
  var i = a, o;
  if (De(Nn, i) && (o = Nn[i], i = "%" + o[0] + "%"), De(ie, i)) {
    var t = ie[i];
  ...
  var i = Bs(a), o = i.length > 0 ? i[0] : "", t = zs("%" + o + "%", n), s = t.name, p = t.value, l = !1, u = t.alias;
...
var Ds = Ns, $n = Ds("%Object.defineProperty%", !0), $s = Is()(), Ms = Mi(), Hs = en, Fe = $s ? Symbol.toStringTag : null, Gs = function(a, n) {
...
}, nn = ft, Ws = ve, Sa = Ya, Js = Xa, Ks = Qa, Ys = Ke.parse, Xs = fi, Qs = $.Stream, ja = Ci, Zs = Dt, er = Gs, Na = Vs, ar = R;
Ws.inherits(R, nn);
function R(e) {
  if (!(this instanceof R))
    return new R(e);
  this._overheadLength = 0, this._valueLength = 0, this._valuesToMeasure = [], nn.call(this), e = e || {};
  for (var a in e)
    this[a] = e[a];
}
R.LINE_BREAK = `\r
...
R.prototype.append = function(e, a, n) {
  ...
  var i = nn.prototype.append.bind(this);
...
R.prototype._multiPartHeader = function(e, a, n) {
  ...
  typeof n.header == "object" && Na(s, n.header);
  var p;
  for (var l in s)
...
R.prototype._getContentDisposition = function(e, a) {
  var n, i;
  return typeof a.filepath == "string" ? n = Sa.normalize(a.filepath).replace(/\\/g, "/") : a.filename || e.name || e.path ? n = Sa.basename(a.filename || e.name || e.path) : e.readable && Object.prototype.hasOwnProperty.call(e, "httpVersion") && (n = Sa.basename(e.client._httpMessage.path || "")), n && (i = 'filename="' + n + '"'), i;
};
R.prototype._getContentType = function(e, a) {
  var n = a.contentType;
  return !n && e.name && (n = ja.lookup(e.name)), !n && e.path && (n = ja.lookup(e.path)), !n && e.readable && Object.prototype.hasOwnProperty.call(e, "httpVersion") && (n = e.headers["content-type"]), !n && (a.filepath || a.filename) && (n = ja.lookup(a.filepath || a.filename)), !n && typeof e == "object" && (n = R.DEFAULT_CONTENT_TYPE), n;
};
...
R.prototype.submit = function(e, a) {
  ...
  return typeof e == "string" ? (e = Ys(e), i = Na({
    port: e.port,
    path: e.pathname,
    host: e.hostname,
    protocol: e.protocol
  }, o)) : (i = Na(e, o), i.port || (i.port = i.protocol == "https:" ? 443 : 80)), i.headers = this.getHeaders(e.headers), i.protocol == "https:" ? n = Ks.request(i) : n = Js.request(i), this.getLength((function(t, s) {
...
function nr(e) {
  return d.isArray(e) && !e.some(Ia);
}
const ir = d.toFlatObject(d, {}, null, function(a) {
  return /^is[A-Z]/.test(a);
});
function na(e, a, n) {
  if (!d.isObject(e))
    throw new TypeError("target must be an object");
  a = a || new (Vi || FormData)(), n = d.toFlatObject(n, {
    metaTokens: !0,
    dots: !1,
    indexes: !1
  }, !1, function(x, v) {
  ...
  function r(f, x, v) {
    ...
    if (f && !v && typeof f == "object") {
      ...
      else if (d.isArray(f) && nr(f) || (d.isFileList(f) || d.endsWith(x, "[]")) && (g = d.toArray(f)))
        return x = Wi(x), g.forEach(function(w, A) {
          !(d.isUndefined(w) || w === null) && a.append(
            // eslint-disable-next-line no-nested-ternary
            s === !0 ? Mn([x], A, t) : s === null ? x : x + "[]",
            u(w)
          );
        }), !1;
    }
    return Ia(f) ? !0 : (a.append(Mn(v, x, t), u(f)), !1);
  }
...
const Ki = Ji.prototype;
Ki.append = function(a, n) {
  this._pairs.push([a, n]);
};
Ki.toString = function(a) {
...
function on(e, a, n) {
  ...
  let t;
  if (o ? t = o(a, n) : t = d.isURLSearchParams(a) ? a.toString() : new Ji(a, n).toString(i), t) {
    const s = e.indexOf("#");
...
}, tr = Ke.URLSearchParams, Aa = "abcdefghijklmnopqrstuvwxyz", Vn = "0123456789", Yi = {
  DIGIT: Vn,
  ALPHA: Aa,
  ALPHA_DIGIT: Aa + Aa.toUpperCase() + Vn
}, sr = (e = 16, a = Yi.ALPHA_DIGIT) => {
  let n = "";
...
}, sn = typeof window < "u" && typeof document < "u", Da = typeof navigator == "object" && navigator || void 0, cr = sn && (!Da || ["ReactNative", "NativeScript", "NS"].indexOf(Da.product) < 0), pr = typeof WorkerGlobalScope < "u" && // eslint-disable-next-line no-undef
self instanceof WorkerGlobalScope && typeof self.importScripts == "function", lr = sn && window.location.href || "http://localhost", ur = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  hasBrowserEnv: sn,
...
function dr(e, a) {
  return na(e, new C.classes.URLSearchParams(), Object.assign({
    visitor: function(n, i, o, t) {
      return C.isNode && d.isBuffer(n) ? (this.append(i, n.toString("base64")), !1) : t.defaultVisitor.apply(this, arguments);
    }
  }, a));
}
function mr(e) {
...
function Xi(e) {
  function a(n, i, o, t) {
    ...
    return s = !s && d.isArray(o) ? o.length : s, l ? (d.hasOwnProp(o, s) ? o[s] = [o[s], i] : o[s] = i, !p) : ((!o[s] || !d.isObject(o[s])) && (o[s] = []), a(n, i, o[s], t) && d.isArray(o[s]) && (o[s] = fr(o[s])), !p);
  }
...
const Ae = {
  ...
  transformRequest: [function(a, n) {
    ...
    if (t && d.isHTMLForm(a) && (a = new FormData(a)), d.isFormData(a))
      return o ? JSON.stringify(Xi(a)) : a;
...
let P = class {
  ...
  set(a, n, i) {
    ...
    if (d.isPlainObject(a) || a instanceof this.constructor)
      s(a, n);
    else if (d.isString(a) && (a = a.trim()) && !gr(a))
      s(hr(a), n);
...
var cn = { exports: {} }, Pe = { exports: {} }, qe = { exports: {} }, Oa, Jn;
function Cr() {
  if (Jn) return Oa;
  Jn = 1;
...
function eo() {
  ...
  Kn = 1;
  function e(a) {
    i.debug = i, i.default = i, i.coerce = u, i.disable = p, i.enable = t, i.enabled = l, i.humanize = Cr(), i.destroy = r, Object.keys(a).forEach((c) => {
      i[c] = a[c];
...
var Le = { exports: {} }, Pa, Xn;
function Or() {
  return Xn || (Xn = 1, Pa = (e, a = process.argv) => {
...
var ei;
function qr() {
  return ei || (ei = 1, typeof process > "u" || process.type === "renderer" || process.browser === !0 || process.__nwjs ? Pe.exports = Tr() : Pe.exports = Pr()), Pe.exports;
}
var ye, Lr = function() {
  if (!ye) {
    try {
      ye = qr()("follow-redirects");
    } catch {
    }
...
}, Ce = Ke, ke = Ce.URL, Ur = Xa, Br = Qa, pn = $.Writable, ln = ko, ao = Lr;
(function() {
...
var zr = [
  ...
  "search",
  "hash"
], dn = ["abort", "aborted", "connect", "error", "socket", "timeout"], mn = /* @__PURE__ */ Object.create(null);
...
var $a = Te(
  ...
  "write after end"
), $r = pn.prototype.destroy || io;
function N(e, a) {
  pn.call(this), this._sanitizeOptions(e), this._options = e, this._ended = !1, this._ending = !1, this._redirectCount = 0, this._redirects = [], this._requestBodyLength = 0, this._requestBodyBuffers = [], a && this.on("response", a);
  var n = this;
  this._onNativeResponse = function(i) {
    try {
      n._processResponse(i);
    } catch (o) {
      n.emit("error", o instanceof Ma ? o : new Ma({ cause: o }));
    }
  }, this._performRequest();
}
N.prototype = Object.create(pn.prototype);
N.prototype.abort = function() {
  xn(this._currentRequest), this._currentRequest.abort(), this.emit("abort");
};
N.prototype.destroy = function(e) {
  return xn(this._currentRequest, e), $r.call(this, e), this;
};
N.prototype.write = function(e, a, n) {
  ...
  this._requestBodyLength + e.length <= this._options.maxBodyLength ? (this._requestBodyLength += e.length, this._requestBodyBuffers.push({ data: e, encoding: a }), this._currentRequest.write(e, a, n)) : (this.emit("error", new Ir()), this.abort());
};
...
N.prototype._processResponse = function(e) {
  ...
  if (xn(this._currentRequest), e.destroy(), ++this._redirectCount > this._options.maxRedirects)
    throw new Nr();
  ...
  a === 303 && !/^(?:GET|HEAD)$/.test(this._options.method)) && (this._options.method = "GET", this._requestBodyBuffers = [], La(/^content-/i, this._options.headers));
  var s = La(/^host$/i, this._options.headers), p = fn(this._currentUrl), l = s || p.host, u = /^\w+:/.test(n) ? this._currentUrl : Ce.format(Object.assign(p, { host: l })), r = Mr(n, u);
  if (ao("redirecting to", r.href), this._isRedirect = !0, Ha(r, this._options), (r.protocol !== p.protocol && r.protocol !== "https:" || r.host !== l && !Hr(r.host, l)) && La(/^(?:(?:proxy-)?authorization|cookie)$/i, this._options.headers), se(o)) {
    var c = {
      headers: e.headers,
      statusCode: a
    }, m = {
...
function no(e) {
  ...
  return Object.keys(e).forEach(function(i) {
    ...
    function p(u, r, c) {
      return Vr(u) ? u = Ha(u) : oe(u) ? u = Ha(fn(u)) : (c = r, r = oo(u), u = { protocol: o }), se(r) && (c = r, r = null), r = Object.assign({
        maxRedirects: a.maxRedirects,
        maxBodyLength: a.maxBodyLength
      }, u, r), r.nativeProtocols = n, !oe(r.host) && !oe(r.hostname) && (r.hostname = "::1"), ln.equal(r.protocol, o, "protocol mismatch"), ao("options", r), new N(r, c);
    }
    function l(u, r, c) {
...
function fn(e) {
  ...
  if (un)
    a = new ke(e);
  else if (a = oo(Ce.parse(e)), !oe(a.protocol))
    throw new $a({ input: e });
  return a;
}
function Mr(e, a) {
  return un ? new ke(e, a) : fn(Ce.resolve(a, e));
}
function oo(e) {
  if (/^\[/.test(e.hostname) && !/^\[[:0-9a-f]+\]$/i.test(e.hostname))
    throw new $a({ input: e.href || e });
...
function xn(e, a) {
  for (var n of dn)
    e.removeListener(n, mn[n]);
  e.on("error", io), e.destroy(a);
}
function Hr(e, a) {
  ln(oe(e) && oe(a));
...
cn.exports = no({ http: Ur, https: Br });
cn.exports.wrap = no;
var Wr = cn.exports;
const Jr = /* @__PURE__ */ Si(Wr), Me = "1.9.0";
function to(e) {
...
const Kr = /^(?:([^;]+);)?(?:[^;]+;)?(base64|),([\s\S]*)$/;
function Yr(e, a, n) {
  const i = n && n.Blob || C.classes.Blob, o = to(e);
...
class ai extends $.Transform {
  ...
  _transform(a, n, i) {
    const o = this[Ua], t = o.maxRate, s = this.readableHighWaterMark, p = o.timeWindow, l = 1e3 / p, u = t / l, r = o.minChunkSize !== !1 ? Math.max(o.minChunkSize, u * 0.01) : 0, c = (h, f) => {
...
const { asyncIterator: ni } = Symbol, so = async function* (e) {
  e.stream ? yield* e.stream() : e.arrayBuffer ? yield await e.arrayBuffer() : e[ni] ? yield* e[ni]() : yield e;
}, Xr = C.ALPHABET.ALPHA_DIGIT + "-_", Ee = typeof TextEncoder == "function" ? new TextEncoder() : new ve.TextEncoder(), ne = `\r
`, Qr = Ee.encode(ne), Zr = 2;
class ec {
  constructor(a, n) {
    ...
    o ? n = Ee.encode(String(n).replace(/\r?\n|\r\n?/g, ne)) : t += `Content-Type: ${n.type || "application/octet-stream"}${ne}`, this.headers = Ee.encode(t + ne), this.contentLength = o ? n.byteLength : n.size, this.size = this.headers.byteLength + this.contentLength + Zr, this.name = a, this.value = n;
  }
  async *encode() {
    yield this.headers;
    const { value: a } = this;
    d.isTypedArray(a) ? yield a : yield* so(a), yield Qr;
  }
  static escapeName(a) {
...
const ac = (e, a, n) => {
  const {
    ...
    size: o = 25,
    boundary: t = i + "-" + C.generateString(o, Xr)
  } = n || {};
  if (!d.isFormData(e))
  ...
  return Number.isFinite(l) && (r["Content-Length"] = l), a && a(r), wo.from(async function* () {
    for (const c of u)
      yield s, yield* c.encode();
    yield p;
  }());
};
class nc extends $.Transform {
  __transform(a, n, i) {
    this.push(a), i();
  }
  _transform(a, n, i) {
...
const ic = (e, a) => d.isAsyncFn(e) ? function(...n) {
  const i = n.pop();
...
}, oi = d.isFunction(Q.createBrotliDecompress), { http: rc, https: cc } = Jr, pc = /https:?/, ti = C.protocols.map((e) => e + ":"), si = (e, [a, n]) => (e.on("end", n).on("error", n), a);
function lc(e, a) {
...
const uc = typeof process < "u" && d.kindOf(process) === "process", dc = (e) => new Promise((a, n) => {
  let i, o;
  const t = (l, u) => {
    o || (o = !0, i && i(l, u));
  }, s = (l) => {
...
}, ri = (e, a) => mc(d.isObject(e) ? e : { address: e, family: a }), fc = uc && function(a) {
  return dc(async function(i, o, t) {
    ...
    let m, h = !1, f;
    if (p) {
      const k = ic(p, (_) => d.isArray(_) ? _ : [_]);
      p = (_, q, ee) => {
        k(_, q, (F, K, ra) => {
          if (F)
            return ee(F);
          const W = d.isArray(K) ? K.map((D) => ri(D)) : [ri(K, ra)];
    ...
    const y = rn(a.baseURL, a.url, a.allowAbsoluteUrls), w = new URL(y, C.hasBrowserEnv ? C.origin : void 0), A = w.protocol || ti[0];
    if (A === "data:") {
      let k;
      if (c !== "GET")
        return ue(i, o, {
    ...
    if (d.isSpecCompliantForm(s)) {
      ...
      s.size && S.setContentType(s.type || "application/octet-stream"), S.setContentLength(s.size || 0), s = $.Readable.from(so(s));
    ...
    const bo = d.toFiniteNumber(S.getContentLength());
    d.isArray(M) ? (V = M[0], ce = M[1]) : V = ce = M, s && (I || V) && (d.isStream(s) || (s = $.Readable.from(s, { objectMode: !1 })), s = $.pipeline([s, new ai({
      maxRate: d.toFiniteNumber(V)
    })], d.noop), I && s.on("progress", si(
      s,
      He(
        bo,
        xe(Ge(I), !1, 3)
    ...
    !d.isUndefined(p) && (B.lookup = p), a.socketPath ? B.socketPath = a.socketPath : (B.hostname = w.hostname.startsWith("[") ? w.hostname.slice(1, -1) : w.hostname, B.port = w.port, ro(B, a.proxy, A + "//" + w.hostname + (w.port ? ":" + w.port : "") + B.path));
    let Oe;
    const sa = pc.test(B.protocol);
    if (B.agent = sa ? a.httpsAgent : a.httpAgent, a.transport ? Oe = a.transport : a.maxRedirects === 0 ? Oe = sa ? Qa : Xa : (a.maxRedirects && (B.maxRedirects = a.maxRedirects), a.beforeRedirect && (B.beforeRedirects.config = a.beforeRedirect), Oe = sa ? cc : rc), a.maxBodyLength > -1 ? B.maxBodyLength = a.maxBodyLength : B.maxBodyLength = 1 / 0, a.insecureHTTPParser && (B.insecureHTTPParser = a.insecureHTTPParser), f = Oe.request(B, function(_) {
      ...
      if (a.decompress !== !1 && _.headers["content-encoding"])
        switch ((c === "HEAD" || _.statusCode === 204) && delete _.headers["content-encoding"], (_.headers["content-encoding"] || "").toLowerCase()) {
          ...
          case "compress":
          case "x-compress":
            q.push(Q.createUnzip(ii)), delete _.headers["content-encoding"];
            break;
          case "deflate":
            q.push(new nc()), q.push(Q.createUnzip(ii)), delete _.headers["content-encoding"];
            break;
          case "br":
            oi && (q.push(Q.createBrotliDecompress(sc)), delete _.headers["content-encoding"]);
        }
      ...
      if (u === "stream")
        ...
        F.on("data", function(U) {
          D.push(U), gn += U.length, a.maxContentLength > -1 && gn > a.maxContentLength && (h = !0, F.destroy(), o(new b(
...
}, xc = C.hasStandardBrowserEnv ? /* @__PURE__ */ ((e, a) => (n) => (n = new URL(n, C.origin), e.protocol === n.protocol && e.host === n.host && (a || e.port === n.port)))(
  new URL(C.origin),
  C.navigator && /(msie|trident)/i.test(C.navigator.userAgent)
) : () => !0, vc = C.hasStandardBrowserEnv ? (
...
const co = (e) => {
  ...
  a.headers = s = P.from(s), a.url = on(rn(a.baseURL, a.url, a.allowAbsoluteUrls), e.params, e.paramsSerializer), p && s.set(
    "Authorization",
  ...
  if (C.hasStandardBrowserEnv && (i && d.isFunction(i) && (i = i(a)), i || i !== !1 && xc(a.url))) {
...
}, ia = typeof fetch == "function" && typeof Request == "function" && typeof Response == "function", po = ia && typeof ReadableStream == "function", kc = ia && (typeof TextEncoder == "function" ? /* @__PURE__ */ ((e) => (a) => e.encode(a))(new TextEncoder()) : async (e) => new Uint8Array(await new Response(e).arrayBuffer())), lo = (e, ...a) => {
  try {
    return !!e(...a);
  } catch {
    return !1;
  ...
  return e && !a;
}), li = 64 * 1024, Ga = po && lo(() => d.isReadableStream(new Response("").body)), Ve = {
  stream: Ga && ((e) => e.body)
};
ia && ((e) => {
...
const Rc = async (e) => {
  ...
  let v;
  try {
    if (l && Ec && n !== "get" && n !== "head" && (v = await Sc(r, i)) !== 0) {
      let S = new Request(a, {
        method: "POST",
        body: i,
        duplex: "half"
    ...
    let y = await fetch(f);
    const w = Ga && (u === "stream" || u === "response");
    if (Ga && (p || w && x)) {
      const S = {};
...
const ui = (e) => `- ${e}`, Ac = (e) => d.isFunction(e) || e === null || e === !1, uo = {
  getAdapter: (e) => {
    e = d.isArray(e) ? e : [e];
    const { length: a } = e;
    let n, i;
    ...
    for (let t = 0; t < a; t++) {
      n = e[t];
      let s;
      if (i = n, !Ac(n) && (i = Va[(s = String(n)).toLowerCase()], i === void 0))
...
` + t.map(ui).join(`
`) : " " + ui(t[0]) : "as no adapter specified";
      throw new b(
...
function di(e) {
  return Ba(e), e.headers = P.from(e.headers), e.data = Ta.call(
    e,
    e.transformRequest
  ), ["post", "put", "patch"].indexOf(e.method) !== -1 && e.headers.setContentType("application/x-www-form-urlencoded", !1), uo.getAdapter(e.adapter || Ae.adapter)(e).then(function(i) {
    return Ba(e), i.data = Ta.call(
      e,
      e.transformResponse,
      i
    ), i.headers = P.from(i.headers), i;
  }, function(i) {
    return Qi(i) || (Ba(e), i && i.response && (i.response.data = Ta.call(
      e,
      e.transformResponse,
      i.response
...
` + t) : i.stack = t;
  ...
  getUri(a) {
    ...
    const n = rn(a.baseURL, a.url, a.allowAbsoluteUrls);
    return on(n, a.params, a.paramsSerializer);
  }
};
...
j.mergeConfig = re;
j.AxiosHeaders = P;
j.formToJSON = (e) => Xi(d.isHTMLForm(e) ? new FormData(e) : e);
...
function vo(e, a) {
  const n = !!(a && a.debug), i = {};
  return e.toString().split(zc).forEach(function(o, t) {
    const s = o.match(Uc);
    if (s != null) {
      const p = s[1];
      let l = s[2] || "";
      const u = l.length - 1, r = l[0] === '"' && l[u] === '"';
      l[0] === "'" && l[u] === "'" || r ? (l = l.substring(1, u), r && (l = l.replace(Bc, Lc))) : l = l.trim(), i[p] = l;
    } else n && xo(`did not match key and value when parsing line ${t + 1}: ${o}`);
  }), i;
}
function Nc(e) {
  let a = qc.resolve(process.cwd(), ".env"), n = "utf8", i = !1;
  e && (e.path != null && (a = e.path), e.encoding != null && (n = e.encoding), e.debug != null && (i = !0));
  try {
    const o = vo(Pc.readFileSync(a, { encoding: n }), { debug: i });
    return Object.keys(o).forEach(function(t) {
      Object.prototype.hasOwnProperty.call(process.env, t) ? i && xo(`"${t}" is already defined in \`process.env\` and will not be overwritten`) : process.env[t] = o[t];
    }), { parsed: o };
  } catch (o) {
    return { error: o };
  }
...
var Ic = ta;
const Dc = /^dotenv_config_(encoding|path|debug)=(.+)$/;
var $c = function(a) {
...
const Mc = yo(import.meta.url), hn = X.dirname(Mc);
process.env.DIST = X.join(hn, "../dist");
...
function ho() {
  Y = new Ja({
    ...
    webPreferences: {
      preload: X.join(hn, "../dist-electron/preload.mjs"),
      nodeIntegration: !1,
      contextIsolation: !0
    }
...
Je.on("activate", () => {
  Ja.getAllWindows().length === 0 && ho();
});
Je.whenReady().then(() => {
  ho(), Ka.on("show-reminder-notification", (e, a) => {
...
Ka.handle("get-air-quality", async (e, a, n, i) => {
  var u, r, c, m;
