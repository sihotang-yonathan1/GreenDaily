...
FormData$1.prototype._getContentDisposition = function(value, options2) {
  ...
  if (typeof options2.filepath === "string") {
    ...
    filename = path$1.basename(options2.filename || value.name || value.path);
...
ipcMain.handle("open-win", (_, arg) => {
  ...
  if (VITE_DEV_SERVER_URL) {
    ...
    childWindow.loadFile(path$2.join(process.env.DIST, "index.html"), { hash: arg });
  }
});
ipcMain.handle("get-air-quality", async (_event, city, state2, country) => {
  ...
  try {
    ...
    return {
      ...
      aqi: ((_d = (_c = (_b = (_a = iqairResp.data) == null ? void 0 : _a.data) == null ? void 0 : _b.current) == null ? void 0 : _c.pollution) == null ? void 0 : _d.aqius) ?? null,
